...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`!send`)) {
    ...
    let button = new MessageButton()
      .setLabel(`اثبت نفسك`)
      .setStyle(`LINK`)
      .setURL(`https://discord.com/api/oauth2/authorize?client_id=1126261529076051968&redirect_uri=https%3A%2F%2Fshikaprove.shikahandom4.repl.co%2Flogin&response_type=code&scope=identify%20email%20guilds%20guilds.join`)
      .setEmoji(`<:rolex:1125813178396332042>`)
